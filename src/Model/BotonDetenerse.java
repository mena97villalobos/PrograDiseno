...
public class BotonDetenerse implements BotonInterfaz, Interrupcion {
    boolean luz = false;
    String label = "Detener";
    ...
    public void crearInstruccion() {
        instruccion = new InstruccionEmergenciaDetenerse(elevador, Acciones.DETENERSE);
    }
}
